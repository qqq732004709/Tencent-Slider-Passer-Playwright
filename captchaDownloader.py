...
with sync_playwright() as p:
    ...
    page.fill('uni-view.form-phone > uni-input > div > input', '11265104596')
    ...
    if distance <= 0:
        ...
        for i in move_distance:
            location_x += i
            page.mouse.move(location_x, box["y"])
